...
import { IProject } from 'app/shared/model/pontoeletronicoService/project.model';
...
export class ProjectService {
  public resourceUrl = SERVER_API_URL + 'services/pontoeletronicoservice/api/projects';
