...
@EnableZuulProxy
class PontoeletronicoWebApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes pontoeletronicoWeb.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<PontoeletronicoWebApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(PontoeletronicoWebApp::class.java)
