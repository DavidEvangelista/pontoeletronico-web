package br.com.ais.pontoeletronico.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(br.com.ais.pontoeletronico.repository..*)" +
            " || within(br.com.ais.pontoeletronico.service..*)" +
            " || within(br.com.ais.pontoeletronico.web.rest..*)"
    )
